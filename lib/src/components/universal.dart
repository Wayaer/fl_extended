...
class Universal extends StatelessWidget {
  ...
  Widget buildClip(Widget current, {CustomClipper<dynamic>? clipper}) {
    ...
    if (isOval) {
      assert(
        !(clipper != null) || clipper is CustomClipper<Rect>,
        "When 'isOval' is true and 'clipper' is provided, 'clipper' must be of type CustomClipper<Rect>.",
      );
      return ClipOval(
      ...
      assert(
        !(clipper != null) || clipper is CustomClipper<Rect>,
        "When 'isClipRect' is true and 'clipper' is provided, 'clipper' must be of type CustomClipper<Rect>.",
      );
      return ClipRect(
        clipper: clipper is CustomClipper<Rect> ? clipper : null,
    ...
    } else if (clipper is CustomClipper<Path> || isClipPath) {
      assert(
        !(clipper != null) || clipper is CustomClipper<Path>,
        "When 'isClipPath' is true and 'clipper' is provided, 'clipper' must be of type CustomClipper<Path>.",
      );
      return ClipPath(
      ...
      assert(
        !(clipper != null) || clipper is CustomClipper<RRect>,
        "When 'isClipRRect' is true and 'clipper' is provided, 'clipper' must be of type CustomClipper<RRect>.",
      );
      return ClipRRect(
